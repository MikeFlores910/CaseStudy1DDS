...
# Load .csv data file
bandit = read.csv("C:/Users/mflor/OneDrive/Documents/000SMU/6306_Doing Data Science/CSProject01/CaseStudy1-data.csv",header = TRUE)
...
cat2_percent = cat2 %>% group_by(CatVar, Category, Attrition) %>% summarise(count = n(), .groups = 'drop') %>% group_by(CatVar, Category) %>% mutate(percent = count / sum(count) * 100)
...
validation = read.csv("C:/Users/mflor/OneDrive/Documents/000SMU/6306_Doing Data Science/CSProject01/CaseStudy1CompSet No Attrition.csv", header = TRUE)
